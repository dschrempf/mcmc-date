...
[[https://github.com/dschrempf/mcmc-date/blob/master/tutorial/data/strassert-320genes-136taxa.phy][=strassert-320genes-136taxa.phy=]] in the [[https://github.com/dschrempf/mcmc-date/tree/master/tutorial/data][data subfolder]] of this tutorial.

Further, we need a topology to date. [cite/text:@Strassert2021] discuss one
unrooted topology with two possible root positions. (1) The root separates
amorphea from diaphoretickes and excavates (see Figure 3 in
[cite/text:@Strassert2021]), and (2) the root separates amorphea and excavates
from diaphoretickes. Here, we choose option (1) which is the more plausible one.
