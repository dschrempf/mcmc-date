...
#+name: Step1-Phylobayes
#+begin_src sh :exports both :wrap "src sh" :results output
cat data/1-phylobayes.sh
#+end_src

#+results: Step1-Phylobayes
#+begin_src sh
#!/usr/bin/env sh
...
from 33 fossil calibrations compiled by [cite/t:@Strassert2021]. I provide the
rooted tree and the calibration file in the [[https://github.com/dschrempf/mcmc-date/tree/master/tutorial/data][data directory]].
