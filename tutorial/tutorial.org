...
Here, we focus on the second alignment with 136 taxa. I have cleaned the taxon
names so they are shorter and I have converted the file from FASTA format to
Phylip format which is required by Phylobayes [cite:@Lartillot2013]. I provide
the alignment [[https://github.com/dschrempf/mcmc-date/blob/master/tutorial/data/strassert-320genes-136taxa.phy][=strassert-320genes-136taxa.phy=]] in the [[https://github.com/dschrempf/mcmc-date/tree/master/tutorial/data][data subfolder]] of this
tutorial.
