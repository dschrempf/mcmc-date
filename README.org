The program [[https://github.com/dschrempf/mcmc-date][McmcDate]] can date a phylogenetic tree with constraints. That is, it
...
For documentation, please see the [[file:tutorial/tutorial.org][McmcDate tutorial]].
